...
**Я Андрій**, аналітик даних, що спеціалізується на Python, SQL, Excel, інструментах бізнес-аналітики та сучасних платформах штучного інтелекту. Тут ви знайдете мої проекти з аналізу даних, створення інформаційних панелей та бізнес-метрик.  Моя мета — перетворити дані на чіткі ідеї та професійні бізнес-рішення.  
**Я відкритий до співпраці та нових можливостей.**

### EN: My stack of technologies, methods and skills | UA: Мій набір технологій, методів та навичок
